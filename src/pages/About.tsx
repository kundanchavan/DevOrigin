        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <p className="text-slate-500 text-lg leading-relaxed mb-8">
              Dew Origin began with a simple observation: tap water is a chemical soup. Our founders, former biotech engineers, spent 4 years developing the "Matrix" membrane—a filtration system that replicates the natural purification cycles of the Swiss Alps.
            </p>
