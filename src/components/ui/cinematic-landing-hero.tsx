...
export function CinematicHero({ 
  ...
  cardDescription = <><span className="text-white font-semibold">Aura Core</span> provides 9-stage filtration with real-time monitoring and antioxidant re-infusion for the purest water on the planet.</>,
  metricValue = 99.9,
  metricLabel = "Purity %",
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        ...
        .fromTo(".floating-badge", { y: 80, autoAlpha: 0, scale: 0.7, rotationZ: -10 }, { y: 0, autoAlpha: 1, scale: 1, rotationZ: 0, ease: "back.out(1.5)", duration: 1, stagger: 0.15 }, "-=1.5")
        .fromTo(".card-left-text", { x: -50, autoAlpha: 0 }, { x: 0, autoAlpha: 1, ease: "power4.out", duration: 1 }, "-=1")
        ...
        .to(".cta-wrapper", { autoAlpha: 0, scale: 0.9, y: -50, duration: 0.8, ease: "power2.in" }, "-=0.3");
  ...
  return (
    <div
      ref={containerRef}
      className={cn("relative w-full h-screen overflow-hidden flex items-center justify-center bg-slate-950 text-white font-sans antialiased", className)}
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-full px-4 gsap-reveal pointer-events-auto will-change-transform">
        <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight text-silver-matte text-center">
          {ctaHeading}
        </h2>
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                ...
                {/* The 3D Water Purifier Unit */}
                <div
                  ref={mockupRef}
                  className="relative w-[320px] h-[580px] rounded-[3rem] overflow-hidden flex flex-col will-change-transform transform-style-3d group"
                >
                  {/* Glass Container for the unit */}
                  <div className="absolute inset-0 bg-gradient-to-b from-blue-500/10 to-transparent backdrop-blur-sm rounded-[3rem] border border-white/10 z-0" />
                  
                  {/* The actual unit image */}
                  <div className="absolute inset-4 bg-slate-900 rounded-[2.5rem] overflow-hidden shadow-2xl z-10 border border-white/5">
                    <img 
                      src="https://images.unsplash.com/photo-1585338107529-13afc5f02586?auto=format&fit=crop&q=80&w=1200" 
                      alt="Aura PURITY Molecular Unit"
                      className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                      referrerPolicy="no-referrer"
                    />
                    <div className="absolute inset-0 screen-glare z-20 pointer-events-none" />
                    
                    {/* Floating Tech Labels */}
                    <div className="absolute bottom-8 left-0 w-full px-6 z-30">
                      <div className="p-4 rounded-2xl bg-black/40 backdrop-blur-md border border-white/10">
                        <div className="flex justify-between items-end">
                          ...
                          <div className="text-right">
                            <p className="text-[10px] text-white/40 font-bold uppercase tracking-widest mb-1">Purity</p>
                  ...
                  {/* Glow effect */}
                  <div className="absolute -inset-20 bg-blue-500/20 blur-[100px] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
                </div>
